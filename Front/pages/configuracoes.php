...
<body class="bg-main min-h-screen flex flex-col md:flex-row overflow-x-hidden">
    ...
    <main class="flex-1 min-w-0 p-4 md:p-8">
        <header class="mb-8">
            <h1 class="cdi-text-3xl font-bold text-gray-800">Configurações</h1>
        ...
        <div class="max-w-4xl mx-auto space-y-8">
            ...
            <section class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden animate-fade-in">
                <div class="cdi-bg-accent text-white px-6 py-4 flex items-center">
                    <i class="fas fa-palette mr-3 cdi-text-xl"></i>
                    <h2 class="cdi-text-lg font-semibold">Aparência e Temas</h2>
                </div>
                ...
                <div class="p-6 md:p-8 space-y-10">
                    ...
                    <!-- Cores do Tema -->
                    <div>
                        <h3 class="cdi-text-sm font-bold cdi-text-gray uppercase tracking-wider mb-4">Cor Principal do Sistema</h3>
                        ...
                        <p class="mt-4 cdi-text-sm cdi-text-muted">Esta cor será aplicada em botões, links e destaques em todas as páginas.</p>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="font-bold text-gray-800 cdi-text-lg">Modo Escuro</h3>
                            <p class="cdi-text-sm cdi-text-muted max-w-md">Inverte as cores de fundo e texto para proporcionar mais conforto visual em ambientes com pouca luz.</p>
                        </div>
            ...
            <section class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden animate-fade-in">
                <div class="cdi-bg-dark text-white px-6 py-4 flex items-center">
                    <i class="fas fa-user-shield mr-3 cdi-text-xl"></i>
                    <h2 class="cdi-text-lg font-semibold">Segurança da Conta</h2>
                </div>
                <div class="p-6 md:p-8">
                    <h3 class="cdi-text-sm font-bold cdi-text-gray uppercase tracking-wider mb-6">Alterar Senha de Acesso</h3>
                    
                    <form id="formAlterarSenha" class="space-y-4 max-w-md">
                        <div>
                            <label class="block cdi-text-sm font-medium text-gray-700 mb-1">Senha Atual</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block cdi-text-sm font-medium text-gray-700 mb-1">Nova Senha</label>
                            ...
                            <div>
                                <label class="block cdi-text-sm font-medium text-gray-700 mb-1">Confirmar Nova Senha</label>
