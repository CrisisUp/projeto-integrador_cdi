                    ...
                    <div class="px-8 pb-8 -mt-12">
                        <div class="flex flex-col md:flex-row items-end gap-6 mb-6">
                            ...
                            <div class="pb-2 flex gap-3">
                                ...
                                <span class="px-4 py-2 rounded-full bg-green-100 text-green-700 font-bold text-sm flex items-center">
                    ...
                    <div class="lg:col-span-2 space-y-10">
                        ...
                        <section>
                            <h2 class="text-xl font-bold text-gray-800 flex items-center mb-6">
                                <i class="fas fa-history mr-3 text-primary" style="color: var(--primary-color);"></i>
                                Evoluções e Atividades
                            </h2>
                            <div class="space-y-4">
                                ${data.atividades.length > 0 ? data.atividades.map(at => `
                                    <div class="relative pl-10 timeline-item">
                                        <div class="absolute left-0 w-6 h-6 rounded-full bg-white border-4 border-primary flex items-center justify-center z-10" style="border-color: var(--primary-color);"></div>
                                        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                                            <div class="flex justify-between items-start mb-2">
                                                <span class="text-xs font-bold text-primary uppercase" style="color: var(--primary-color);">${at.tipo}</span>
                                ...
                                ${data.encaminhamentos.length > 0 ? data.encaminhamentos.map(en => `
                                    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
                                        <div class="flex justify-between items-start mb-3">
                                            <span class="px-3 py-1 rounded-full text-[10px] font-bold uppercase ${en.status === 'Concluído' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'}">
                                                ${en.status}
                                            </span>
                                        ...
                                        <p class="text-xs text-gray-500">Urgência: <span class="font-bold ${en.urgencia === 'Urgente' ? 'text-red-500' : 'text-gray-700'}">${en.urgencia}</span></p>
                                    </div>
