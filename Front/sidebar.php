...
<aside class="w-full md:w-64 border-r border-gray-300 bg-white flex flex-col transition-all duration-300 md:h-screen sticky top-0 z-40 sidebar">
    <div class="p-6 flex items-center border-b border-gray-100">
        <div class="w-10 h-10 rounded-xl bg-primary flex items-center justify-center text-white shadow-lg" style="background-color: var(--primary-color);">
    ...
    <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
        <a href="navegacao.php" class="flex items-center p-3 text-gray-700 sidebar-item rounded-full mb-2 transition hover:bg-gray-100">
            <i class="fas fa-home mr-4 text-xl"></i><span class="text-xl">Início</span>
        </a>
        <a href="cadastro.php" class="flex items-center p-3 text-gray-700 sidebar-item rounded-full mb-2 transition hover:bg-gray-100">
            <i class="fas fa-user-plus mr-4 text-xl"></i> <span class="text-xl">Cadastro</span>
        </a>
        <a href="presenca.php" class="flex items-center p-3 text-gray-700 sidebar-item rounded-full mb-2 transition hover:bg-gray-100">
        ...
        <a href="enfermagem.php" class="flex items-center p-3 text-gray-700 sidebar-item rounded-full mb-2 transition hover:bg-gray-100">
